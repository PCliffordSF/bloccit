...
RSpec.describe QuestionsController, type: :controller do
  ...
  ### these are the ---index GET--- route tests
  describe "GET #index" do
    ...
    it "assigns [my_question] to @questions" do
       ...
       expect(assigns(:questions)).to eq([my_question]) # only created one, so index = only my_questiono
    end
  end
  
  ### these are the ---show GET--- route tests
  ...
  ### these are the ---new GET--- route tests
  ...
  ### these are the ---create POST--- tests
  ...
  ### these are the ---edit GET--- route tests
  ...
  ### these are the ---edit PUT--- route tests
