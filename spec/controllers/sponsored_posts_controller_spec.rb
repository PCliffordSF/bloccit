...
RSpec.describe SponsoredPostsController, type: :controller do
   ...
   let(:my_sponsored_post) { my_topic.sponsored_posts.create!(title: RandomData.random_word, body: RandomData.random_paragraph, price: RandomData.random_price) }
   ...
   describe "GET show" do
    ...
    describe "POST create" do
      ...
      it "increases the number of Sponsored Post by 1" do
         expect{post :create, topic_id: my_topic.id, sponsored_post: {title: RandomData.random_sentence, body: RandomData.random_paragraph, price: RandomData.random_price
